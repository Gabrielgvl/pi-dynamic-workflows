...
/**
 * Readonly literal schema subset accepted in workflow scripts.
 *
 * This is intentionally not a full JSON Schema type. Supported keywords are
 * `type`, `properties`, `required`, boolean `additionalProperties`, `items`,
 * primitive `enum`, and `description`. TypeScript callers that need broader
 * validation should pass a TypeBox `TSchema` instead.
 */
