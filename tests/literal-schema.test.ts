...
test("literal TypeBox-compatible subset validates required object fields, arrays, and nested objects", async () => {
...
test("literal TypeBox-compatible subset rejects invalid nested output", () => {
